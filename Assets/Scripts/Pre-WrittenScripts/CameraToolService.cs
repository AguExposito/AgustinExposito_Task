...
namespace Code.CameraTool
{
    public class CameraToolService : MonoBehaviour
    {
        ...
        public CinemachineFreeLook TPCharacterCamera;
        ...
        {
            if (CameraToolUI == null || CameraToolUI.RootNode == null || !CameraToolUI.RootNode.activeSelf)
                return;
        ...
        public bool ActivateCameraTool()
        {
            ...
            {
                if (TPCharacterCamera != null)
                {
                    TPCharacterCamera.Priority = 0;
                }
                else if (TPCharacterVCamera != null)
                {
                    TPCharacterVCamera.Priority = 0;
                }
                else
                {
                    Debug.LogWarning("CameraToolService: No TP Character camera assigned.");
                }
            }
            else
            {
        ...
        {
            FindAnyObjectByType<CameraShotImage>()?.TakePhoto();
